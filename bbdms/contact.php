	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Contact Us - Newsletter</h3>
				<span>
					<i class="fas fa-user-md"></i>
				</span>
				<p class="mt-2">By getting in touch with us, you opt for our informative Newsletter Service. We will respond within 24 hrs, that's our promise!</p>
			</div>
			<div class="d-flex">
