      ...
      <div class="container py-xl-5 py-lg-3">
        <div class="row">
          <div class="col-md-4 w3l-footer">
            ...
            <p>"Welcome to our Blood Bank and Donor System, your go-to platform for efficient blood donation and distribution management. Our system streamlines the process of connecting donors with recipients in need, ensuring timely access to safe and quality blood supplies. Join us in making a difference and saving lives through the power of voluntary blood donation. Together, we can create a healthier and more resilient community."</p>
          </div>
